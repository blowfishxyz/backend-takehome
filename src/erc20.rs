...
/// List of generic, known ERC20 contract addresses.
///
/// ```
/// use crate::erc20_transfer_checker::erc20::ContractAddress;
/// use std::str::FromStr;
/// use ethers::types::H160;
///
...
/// let usdc_address: ethers::types::H160 = ContractAddress::USDC.into();
...
impl ContractAddress {
	fn contract_and_address() -> HashMap<ContractAddress, H160> {
		hashmap! {
            ContractAddress::WETH => H160::from_str("C02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2").unwrap(),
